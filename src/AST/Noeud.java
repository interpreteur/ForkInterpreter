...
public abstract class Noeud {
    ...
    protected Noeud etatPrecedent;
    protected String typeCommande;
    protected Expression expr;

    public Noeud(Noeud etatPrecedent, String typeCommande, Expression expr) {
     ...
     * @return 
     */
    public abstract String reconnaitre(String instruction) throws ComandeNonReconnu;
    ...
    public Noeud getEtatPrecedent() {
        return etatPrecedent;
    }

    public void setEtatPrecedent(Noeud etatPrecedent) {
        this.etatPrecedent = etatPrecedent;
    }
    ...
    public boolean estUneAssignation(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.assignation);
    }
    
    public boolean estUneIteration(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.iteration);
    }
    
    public boolean estUneSequence(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.sequence);
    }
    
    public boolean estUneConditionelle(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.conditionelle);
    }
    
    public boolean estUneDeclarationVariable(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.declarationVariable);
    }
    
    public boolean estUnAliasing(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.aliasing);
    }
    
    public boolean estUnFork(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.creationProcessus);
    }
    
    public boolean estUnWait(String messageException){
        return messageException.equalsIgnoreCase(Typecommande.attenteProcessus);
    }
