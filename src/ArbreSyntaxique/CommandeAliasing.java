 ...
 * @author ishola hamed
 */
public class CommandeAliasing extends LanceurCom{
    private String ide1;
    private String ide2;
    private String com;
    
    public CommandeAliasing(){}

    public CommandeAliasing(String ide1, String ide2, String com) {
        this.ide1 = ide1;
        this.ide2 = ide2;
        this.com = com;
    }
    ...
    public void executerAliasing() throws ConflitVariableName, VariableNotExist{
        ...
        if(environnement.containsKey(getIde1())){
            if (environnement.containsKey(getIde2())) {
                throw new ConflitVariableName("Conflit de nom",getIde2(), cmdEntiere);
            }else{
            ...
            throw new VariableNotExist("Variable", getIde1(), cmdEntiere);
        } 
    }
