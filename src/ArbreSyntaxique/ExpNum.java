 ...
 * @author ishola hamed
 */
public class ExpNum extends Expression{

    public ExpNum() {}

    public ExpNum(Expression expArithGauche, String operateur, Expression expArithDroite, boolean exprComplete) {
        super(expArithGauche, operateur, expArithDroite, exprComplete);
    }

    public ExpNum(Expression expArithGauche, String operateur, Expression expArithDroite) {
