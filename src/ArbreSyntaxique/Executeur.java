...
import AnalyseurLexical.Constante;
...
public class Executeur {
     ...
     */
    /*
    public void executer(String suiteDeCommandes) throws ExceptionConflitNoms{
        //System.out.println("suitesCmd == "+suiteDeCommandes);
        ExecuteurAssignation execAssignation = new ExecuteurAssignation();
        ExecuteurAliasing execAliasing = new ExecuteurAliasing();
        ExecuteurDeclarationVar execDeclVar = new ExecuteurDeclarationVar();
        ExecuteurConditionelle execConditionel = new ExecuteurConditionelle();
        ExecuteurIteration execIteration  = new ExecuteurIteration();
    ...
    */
     ...
     * @param seqCmd
     * @return
     * @throws ExceptionConflitNoms 
     */
    public void executer(String seqCmd) throws ExceptionConflitNoms, ExceptionVariableNonDeclaree{
        ...
        if( isAssignationCommande(typeCmd) ){
            ...
            indexPV = ptVirguleCmd.getIndexPointVirgule();
            ExecuteurConditionelle execC = (ExecuteurConditionelle)ptVirguleCmd.getExecuteur();
            ...
            indexPV = ptVirguleCmd.getIndexPointVirgule();
            ExecuteurIteration execI = (ExecuteurIteration)ptVirguleCmd.getExecuteur();
            ...
            indexPV = ptVirguleCmd.getIndexPointVirgule();
            ExecuteurDeclarationVar execD = (ExecuteurDeclarationVar)ptVirguleCmd.getExecuteur();
            ...
            indexPV = ptVirguleCmd.getIndexPointVirgule();
            ExecuteurAliasing execAL = (ExecuteurAliasing)ptVirguleCmd.getExecuteur();
    ...
    public SequenceCommande extraireIteration(String seqCmd){
        ...
        ExecuteurIteration execI = new ExecuteurIteration(BExp, Com);
    ...
    public SequenceCommande extraireConditionelle(String seqCmd){
        ...
        ExecuteurConditionelle execC = new ExecuteurConditionelle(BExp, Com1, Com2);
    ...
    public SequenceCommande extraireDeclarationVar(String seqCmd){
        ...
        ExecuteurDeclarationVar execD = new ExecuteurDeclarationVar(ide, com);
    ...
    public SequenceCommande extraireAliasing(String seqCmd){
        ...
        //on reconstitue la commande en entier
        ExecuteurAliasing execAL = new ExecuteurAliasing(ide1, ide2, com);
     ...
     * @return 
     */
    public boolean evaluerBExp(String cmdBExp) throws ExceptionVariableNonDeclaree{
        String mot1, mot2;
        Compteur compteurIndex = new Compteur(0);
    ...
    public boolean evaluerNExpCOpNExp(String cmdNExpCOpNExp) throws ExceptionVariableNonDeclaree{
     ...
     * @param exp
     * @return
     * @throws ExceptionVariableNonDeclaree 
     */
    public int calculerExpression(String exp) throws ExceptionVariableNonDeclaree{
                    ...
                    nvExpr.setExpDroite(num);
                     ...
                     if(Character.isLetter(str.charAt(0))){ // Si le 1er Caractere est une lettre, alors, c'est un IDE
                         if(environnement.containsKey(str)){  //permet de tester si la variable a été declarée
                            ...
                            throw new ExceptionVariableNonDeclaree("",str,exp);
                        }
        ...
        if ( estUnIDE(mot) ){
            ...
            if(mot.equalsIgnoreCase("if")){
                ...
                if(motReserve.equalsIgnoreCase("in")){
                    return Constante.declarationVariable;
                }else if(motReserve.equalsIgnoreCase("be")){
                    return Constante.aliasing;
                }
            }
        }
        return null;
    ...
    public boolean isAssignationCommande(String typeCommande){
        return typeCommande.equalsIgnoreCase(Constante.assignation);
    }
    ...
    public boolean isConditionnelleCommande(String typeCommande){
        return typeCommande.equalsIgnoreCase(Constante.conditionelle);
    }
    ...
    public boolean isIterationCommande(String typeCommande){
        return typeCommande.equalsIgnoreCase(Constante.iteration);
    }
    ...
    public boolean isAliasingCommande(String typeCommande){
        return typeCommande.equalsIgnoreCase(Constante.aliasing);
    }
